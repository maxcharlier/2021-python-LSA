...
curves_names.append("1 Channel - agreg 1")
input_params.append(dir_path + "/ch1-agr14.csv")
curves_names.append("1 Channel - agreg 14")
input_params.append(dir_path + "/ch2-agr1.csv")
curves_names.append("2 Channels - agreg 1")
input_params.append(dir_path + "/ch2-agr14.csv")
curves_names.append("2 Channels - agreg 14")
input_params.append(dir_path + "/ch8-agr1.csv")
curves_names.append("8 Channels - agreg 1")
input_params.append(dir_path + "/ch8-agr14.csv")
curves_names.append("8 Channels - agreg 14")

# for file in input_params:
#   gen_topology(Bunch_Parameters.get_parameters_from_file(file), plot_graph=False)

slot_frame_length_graph(input_params, curves_names, output_file, title="", yticks=range(0, 1401, 100))
