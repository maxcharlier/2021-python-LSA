...
# slot_frame_lenght_graph(input_params, curves_names, output_file, title="", yticks=range(0, 1201, 100))
...
positionning_frequency_bars(dir_path + "/topology_param.csv", output_file="positionning_frequency_bars.pdf", title="Frequency of positioning", timeslot_duration=2.5, savefig=True)
