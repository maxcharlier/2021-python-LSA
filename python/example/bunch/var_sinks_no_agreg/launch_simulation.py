...
slotframe_length_bars(dir_path + "/topology_param.csv", output_file="slotframe_length_bars_8ch.pdf", title="", savefig=True, display_xlabels=True, timeslot_duration =5)
